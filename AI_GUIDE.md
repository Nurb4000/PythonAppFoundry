...
31. **Declare Python dependencies in module XML** — If your module needs extra libraries (e.g., `requests`, `pandas`, `pillow`), add a `<requirements>` element in the XML bundle. Each line is passed to `pip install` on import. Example:
    ```xml
    <requirements>
    requests==2.31.0
    pandas
